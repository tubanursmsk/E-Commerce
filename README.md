...
├── Dtos/ → DTO katmanı (Create / Update / List)
├── Services/ → İş kuralları & CRUD işlemleri
├── Mappings/ → AutoMapper profilleri
├── Utils/ → DbContext & yardımcı sınıflar
├── Middleware/ → Exception & log middleware
