...
if (gua.length) {
	...
	var opts = {
		...
		staticLabels: {
			font: "14px Roboto, Arial, sans-serif",  // Specifies font
			labels: [mingua, centergua, maxgua],  // Print labels at these values
