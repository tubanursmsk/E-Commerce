...
public class AutoMapperProfiles : Profile
{
    public AutoMapperProfiles()
    {
        ...
        CreateMap<Product, ProductDto>()
            ...
            .ForMember(dest => dest.BrandName, opt => opt.MapFrom(src => src.Brand.Name)) //ProductDto içinde CategoryName diye bir alan var ama Product entity'
                                                                                        // sinde bu yok (orada sadece Category nesnesi var). .ForMember(...) satırı
                                                                                        //  ile AutoMapper'a: "Category nesnesinin içindeki Name'i al, DTO'daki
                                                                                        //  CategoryName'e // yaz" demiş oluyoruz.  
